            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-8 col-md-offset-2">
                                {!! Form::open(['action' => ['Admin\JobController@update', $job->id]]) !!}
                                <div class="form-group" :class="{'has-error': $v.title.$error}">
                                    {!! Form::label('title', 'ชื่องาน *') !!}
                                    {!! Form::text('title', $job->title, ['class' => 'form-control', 'placeholder' => 'ชื่องาน', 'v-model.trim' => 'title', '@input' => '$v.title.$touch()']) !!}
                                </div>
                                ...
                                <div class="form-group" :class="{'has-error': $v.assignTo.$error}">
                                    ...
                                    {!! Form::select('assignTo', $users, $job->assign_to, ['class' => 'form-control select2', 'placeholder' => 'เลือกผู้ใช้งาน', 'v-model.trim' => 'assignTo', '@input' => '$v.assignTo.$touch()']) !!}
                                </div>
